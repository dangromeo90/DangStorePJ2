...
$client_id = '981805409560-o0hk43h87oketot0g34qsev2vo2j715g.apps.googleusercontent.com'; 
$client_secret = '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';
$redirect_uri = 'http://localhost/dangstore/google/login/login.php';
 
//Thông tin kết nói database
$db_username = "root"; //Database Username
$db_password = ""; //Database Password
$host_name = "localhost"; //Mysql Hostname
$db_name ='dangstorepj2'; //Database Name
###################################################################
